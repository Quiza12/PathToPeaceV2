...
import { P2pYourStoriesInterviewsViewComponent } from './your-stories/interviews/p2p.your-stories.interviews.view.component';
...
@NgModule({
    ...
    declarations: [
        ...
        P2pYourStoriesInterviewsViewComponent,
